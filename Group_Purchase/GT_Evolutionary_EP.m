function [PS,PSV,HV]=GT_Evolutionary_EP(population,stock,preference,genaration,popsize,user,item,mutationrate,maxtimeofinvest,crossrate,timec,price)

HV=[];
for i=1:genaration % 迭代次数为200，类似于epoch
    i   
    %% 种群划分
    ...
    [~,N1] = sortrows(EValue1); % 按目标1排序种群
    [~,N2] = sortrows(EValue2);  % 按目标2排列种群
