function [PS,PSV,HV]=GT_Evolutionary_RandSelect(population,stock,preference,genaration,popsize,user,item,mutationrate,maxtimeofinvest,crossrate,timec,temp,gap,price)
