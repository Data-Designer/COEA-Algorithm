function [PS,PSV,HV]=GT_Evolutionary_Borrowers(population,stock,preference,genaration,popsize,user,item,mutationrate,maxtimeofinvest,timec,price)
...
%         NPOP{j}=local_search1(NPOP{j},OBJ1(j),preference,user,item,mutationrate);
        NPOP{j}=local_search2(NPOP{j},user,item,stock,mutationrate);
    end
