function [PS,PSV,HV]=GT_Evolutionary_MY(population,stock,preference,genaration,popsize,user,item,mutationrate,maxtimeofinvest,crossrate,timec,temp,gap,price)
